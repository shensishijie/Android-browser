...
public class HistoryActivity extends AppCompatActivity {
     ...
     * 判断历史记录表是否有数据
     */
    public static boolean if_exist;

    /**
     * 在遍历时记录下当前item的_id，用于匹配当前点击位置，返回url到主页打开
     */
    public ArrayList arrayList = new ArrayList();

    public static String HISTORY_URL_EXTRA = "com.example.android_browser.history.EXTRAS";
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (if_exist) {
                    ...
                    Intent mIntent = new Intent(HistoryActivity.this, WebViewActivity.class);
                    mIntent.putExtra(HISTORY_URL_EXTRA, query_by_id(position));
